...
const socialLinks = [
  {
    name: "YouTube",
    href: "https://www.youtube.com/@Lifeonbooks",
    icon: (
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@alifeonbooks",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Spotify",
    href: "https://open.spotify.com/show/1wo2MlieosKEXQ59nnEg9B",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Patreon",
    href: "https://www.patreon.com/cw/LifeonBooks",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/Yourlifeonbooks/",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "X",
    href: "https://x.com/TheLifeonBooks",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/alifeonbooks/",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
