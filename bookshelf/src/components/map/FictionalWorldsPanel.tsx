              ...
              <div className="mb-6">
                ...
                {selectedWorld.maps.length === 0 ? (
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8 text-center">
                    <Map className="h-12 w-12 mx-auto mb-2 text-[var(--foreground-secondary)]" />
                  ...
                  {showCreateWorld ? (
                    <form onSubmit={createWorld} className="flex items-end gap-2">
                      ...
                      <button
                        ...
                        className="rounded-lg bg-[var(--color-primary)] px-3 py-2 text-sm font-medium text-[var(--color-primary-contrast)] disabled:opacity-60"
                      >
                    ...
                    >
                      <div className="w-16 h-12 bg-gray-100 dark:bg-gray-800 rounded overflow-hidden flex-shrink-0">
                        {getWorldThumbnail(world) ? (
                          ...
                          <div className="w-full h-full flex items-center justify-center text-[var(--foreground-secondary)]">
