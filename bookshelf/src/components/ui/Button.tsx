...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary:
        "bg-[var(--color-primary)] text-[var(--color-primary-contrast)] hover:bg-[var(--color-primary-dark)] shadow-sm hover:shadow-md",
      secondary:
        "bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 hover:bg-gray-200",
      outline:
        "border-2 border-[var(--color-primary)] bg-transparent text-[var(--color-primary-text)] hover:bg-[var(--color-primary)] hover:text-[var(--color-primary-contrast)]",
      ghost:
