...
| TEST-4, TEST-5, TEST-7, TEST-8, TEST-10 .. TEST-16, TEST-18 .. TEST-20 | the remaining test gaps, each recorded as the concrete mutation that survives. TEST-10 is the largest single one: `wrapped.ts` is 387 lines with zero tests. **TEST-10 closed 2026-09-02** — 38 tests, and two defects it exposed; see [`2026-09-02-wrapped-tests.md`](2026-09-02-wrapped-tests.md) |
